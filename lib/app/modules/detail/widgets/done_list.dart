      ...
      () => homeCtrl.doneTodos.isNotEmpty
          ? ListView(
              ...
              children: [
                ...
                ...homeCtrl.doneTodos
                    .map(
                      // dismissible torna o elemento deslizavel
                      (element) => Dismissible(
                        key: ObjectKey(element),
                        // direção do fim para o começo (direita <- esquerda)
                        direction: DismissDirection.endToStart,
                        // evento de deslizar
                        onDismissed: (_) => homeCtrl.deleteDoneTodo(element),
                        // vamos adicionar no background um icone
                        background: Container(
                          // cor de fundo vermelha com 0.8 de opacidade
                          color: Colors.red.withOpacity(0.8),
                          // centralizando conteúdo a direita
                          alignment: Alignment.centerRight,
                          // um icone filho, tipo delete e cor branca
                          child: Padding(
