...
class HomePage extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // criando o stack para tabalhar com tabs
      // observável para controle da variavel tabindex
      body: Obx(
        () => IndexedStack(
            ...
            SafeArea(
              child: ListView(
                children: [
                  ...
                  Obx(
                    // gridview com observable pra mudar estado em tempo real
                    () => GridView.count(
                      crossAxisCount: 2,
                      shrinkWrap: true,
            ...
            () => FloatingActionButton(
              ...
              onPressed: () {
                if (controller.tasks.isNotEmpty) {
                  // caso a lista de tarefas não esteja fazia
      ...
      // configurando a localização do botão de ação flutuante, centalizando
      floatingActionButtonLocation: FloatingActionButtonLocation.centerDocked,
      // adicionando bottões de navegação no rodape
